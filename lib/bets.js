...
var getBetLAPR = function(err, window, agent, bets){
    ...
    // TO-DO: eliminar &nbsp en la combinación, traducir variables al ingles. y falta la fecha!!
    
    var $ = window.jQuery;
    
    var fecha = '??';
    var combinacion =  $('div.inforesult div#orden1 div.premespe').eq(2).text();
    var complementario =  $('div.inforesult div#orden1 div.premespe').eq(1).text();
    var reintegro =  $('div.inforesult div#orden1 div.premespe').eq(0).text();
     
    bets.push({fecha:fecha, combinacion:combinacion, complementario:complementario, reintegro:reintegro});
